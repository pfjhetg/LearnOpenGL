...
coordinate_systems_depth::coordinate_systems_depth() {
    
}

coordinate_systems_depth::coordinate_systems_depth(GLFWwindow *window) {
    this->window = window;
}

void coordinate_systems_depth::loadShader() {
    glEnable(GL_DEPTH_TEST);
    
    this->shader = new Shader("/Users/pfjhetg/Desktop/LearnOpenGL/LearnOpenGL/Shaders/6.2.coordinate_systems.vert", "/Users/pfjhetg/Desktop/LearnOpenGL/LearnOpenGL/Shaders/6.2.coordinate_systems.frag");
...
void coordinate_systems_depth::renderLoop() {
    // ------
    // 设置清空屏幕所用的颜色
